...
#testing whether 4 demos makes much of a difference
...
####make world
init_states = [(0,0),(4,4),(0,4),(4,0),(2,0),(0,2),(4,2),(2,4)]
term_states = [(2,2)]
weights = [0,-1,1,0,0]
    ...
    for alpha in test_alphas:
        ...
        for num_mcmc_samples in chain_lengths:
            ...
            for rep in range(num_reps):
                ...
                f = open("/home/dsbrown/workspace/IRLConfidenceBounds/paper_test/nav_world/grid5x5/gridnav_ratio_size"+str(size) + "_qpolicyloss" + str(loss) + "_ndemos" + str(len(demos_all)) + "_mcmc"+str(num_mcmc_samples)+"_rep" + str(rep) + "_alpha" + str(alpha) +  ".txt",'w')
